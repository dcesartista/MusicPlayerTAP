...
import com.example.android.musicplayertapz.MusicService.MusicBinder;
...
public class MainActivity extends Activity implements MediaPlayerControl {
	...
	//service
	private com.example.android.musicplayertapz.MusicService musicSrv;
	private Intent playIntent;
	//binding
	private boolean musicBound=false;

	//controller
	private com.example.android.musicplayertapz.MusicController controller;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//instantiate list
		songList = new ArrayList<com.example.android.musicplayertapz.Song>();
		//get songs from device
		getSongList();
		//sort alphabetically by title
		Collections.sort(songList, new Comparator<com.example.android.musicplayertapz.Song>(){
			@Override
		...
		com.example.android.musicplayertapz.SongAdapter songAdt = new com.example.android.musicplayertapz.SongAdapter(this, songList);
	...
	protected void onStart() {
		super.onStart();
		if(playIntent==null){
			playIntent = new Intent(this, com.example.android.musicplayertapz.MusicService.class);
	...
	public void getSongList(){
		...
		if(musicCursor!=null && musicCursor.moveToFirst()){
			...
			do {
				...
				songList.add(new com.example.android.musicplayertapz.Song(thisId, thisTitle, thisArtist));
			} 
	...
	private void setController(){
		controller = new com.example.android.musicplayertapz.MusicController(this);
